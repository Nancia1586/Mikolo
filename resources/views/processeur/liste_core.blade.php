        ...
        <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <h5 class="card-title">Liste des cores de processeurs</h5>
                        </div>
                        <div class="col-md-7">
                            ...
                            <div class="modal fade" id="addService" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/processeur/add_core" method="get" class="row g-3">
                                            <div>
                                                <center><input style="width: 400px;" type="text" class="form-control" id="inputPassword4" name="core"
                                                        placeholder="Core"></center>
                                                <br>
                            ...
                            <div class="modal fade" id="modifier<?php echo $row['id']; ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/processeur/update_core" method="get" class="row g-3">
                                            <div>
                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                <center><input style="width: 400px;" type="text" class="form-control" id="inputPassword4" name="core"
                                                        placeholder="Numero" value="<?php echo $row['core']; ?>"></center>
                            ...
                            <div class="modal fade" id="supprimer<?php echo $row['id']; ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <a href="/processeur/supprimer_core?id=<?php echo $row['id']; ?>"><button style="width: 150px;" type="button" class="btn btn-primary">Supprimer</button></a></center>
                                        <div class="col-md-12" style="height: 20px;">
                  ...
                  <table class="table table-borderless">
                    ...
                    {{-- Recherche multicritere --}}
                     <form action="/processeur/listecore">
                     <tr>
                        <th scope="col">
