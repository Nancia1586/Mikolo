        ...
        <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <h5 class="card-title">Reception des retours de laptop</h5>
                        </div>
                        <div class="col-md-7">
                  ...
                  <table class="table table-borderless">
                    ...
                    {{-- Recherche multicritere --}}
                     ...
                     <tr>
                        ...
                        <th scope="col">
                            <input type="text" name="emplacement" class="form-control" placeholder="Point de vente">
                        </th>
                        <th>
                    ...
                    <form action="/magasin/add_reception" method="get">
                    <tr>
                        <input type="hidden" name="idpointvente" value="<?php echo $row['idpointvente']; ?>">
                        <input type="hidden" name="idrenvoipv" value="<?php echo $row['id']; ?>">
                        <th scope="row">
