        ...
        <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <h5 class="card-title">Liste des types de disque dur</h5>
                        </div>
                        <div class="col-md-7">
                            ...
                            <div class="modal fade" id="addService" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/disquedur/add_type" method="get" class="row g-3">
                                            <div>
                            ...
                            <div class="modal fade" id="modifier<?php echo $row['id']; ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/disquedur/update_type" method="get" class="row g-3">
                                            <div>
                            ...
                            <div class="modal fade" id="supprimer<?php echo $row['id']; ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <a href="/disquedur/supprimer_type?id=<?php echo $row['id']; ?>"><button style="width: 150px;" type="button" class="btn btn-primary">Supprimer</button></a></center>
                                        <div class="col-md-12" style="height: 20px;">
                  ...
                  <table class="table table-borderless">
                    ...
                    {{-- Recherche multicritere --}}
                     <form action="/disquedur/listetype">
                     <tr>
                        <th scope="col">
